...
from .form import CourseTitleForm,CourseCategoryForm,VideoForm,CoursePriceForm,LessonForm

# Create your views here.

def instructor_dashboard(request):
    courses = Course.objects.filter(instructor=request.user)  # Adjust this to fit your model
